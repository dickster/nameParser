...
getName().addRelation(token.image, token.kind);
  ...
  final public void companyTitle() throws ParseException {
    if (jj_2_43(4)) {
...
getCompanyName().addTitle(token.image, token.kind);
  ...
  final public void personalTitle() throws ParseException {
    if (jj_2_47(4)) {
      ...
      jj_consume_token(BBA);
    } else if (jj_2_55(4)) {
      jj_consume_token(MBA);
    } else if (jj_2_56(4)) {
      jj_consume_token(MD);
    } else if (jj_2_57(4)) {
      jj_consume_token(CP);
...
getCompanyName().addName(token.image, token.kind);
 ...
 {
    if (jj_scan_token(MBA)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(BBA)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(JUDGE)) return true;
    return false;
  }
